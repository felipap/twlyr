var vagalume = (function() {
    ...
    return {
        ...
        getTrackIdFromName: function(artistName, trackName, onEnd) {
            ...
            if (typeof trackName === 'function' && !onEnd) {
                onEnd = trackName;
                trackName = '';
            } else if (!trackName)
                trackName = '';
        ...
        getTrackInfoFromName: function(artistName, trackName, onCaptcha, onEnd) {
